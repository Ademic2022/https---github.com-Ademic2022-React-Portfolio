...
const data = [
  ...
  },
  {
    ...
    duration: "2 Years Experience",
    details:
      "During my 2-year stint as a Content Creator, I honed my skills in creating engaging and informative content. Whether it was writing articles, producing videos, or managing social media platforms, I successfully communicated complex concepts in an accessible manner.",
  },
];
